...
const client_id = 'da60d474cb724133b3ea18f572abe288';
const client_secret = '62c4b3d7571c48f0b098c4749daf34e6';
const refresh_token = 'AQAXO99jPstdhF8-oEE60iOLErYSUV4_tac5UiBumGwYJ_IaW4BR5tPTWu9EXMzHPP1AIBTO1pzMygPfCmF3cRQAg_BYTI04NovK8--nK4EaTte7QdWCTv7sKUtsEG_AQN8';
...
export const getNowPlaying = async () => {
  try {
    ...
    if (response.status > 400) {
      ...
      //Display results of last played song.?
    }
